...
<head>
    ...
    <title>Nicholas Serrano Assignment 2 Part 2</title>
        ...
        <div id="main">
            <div class="main2_center">
                ...
                <header id="header">
                    ...
                    <div class="fas nav_button" id="LessonHomeButton">Home</div>
                    <div class="fas nav_button" id="LessonUploadButton">Upload</div>
                    <div class="fas nav_button" id="LessonManageButton">Manage</div>
                </header>
                ...
                <section class="main2-banner-container" id="Main2-container">
                    ...
                    <div class="main2-banner-title">Courses For You</div>
            ...
            <div class="inner_sidebar">
                ...
                <nav id="menu">
                    <ul>
                        ...
                        <li><a href="main2.php">Lesson Service</a></li>
