...
async function addTocart(itemID){
    ...
    const error = await addCartDB(myArr[0],myArr[1],myArr[2],myArr[3],myArr[4],myArr[5],myArr[6],myArr[7]);
...
const addCartDB = async (computerID,cpuID,graphicsID,hardDriveID,ramID,osID,displayID,soundCardID) => {
    ...
    url.searchParams.append('hardDriveID', hardDriveID)
    url.searchParams.append('ramID', ramID)
    url.searchParams.append('osID', osID)
    url.searchParams.append('displayID', displayID)
    url.searchParams.append('soundCardID', soundCardID)
